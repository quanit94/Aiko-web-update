@section('bonusCss')
<link href="{{ url('public/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}" rel="stylesheet" type="text/css">
@stop
<div class="box">
...
@section('bonusJs')
<script src="{{ url('public/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}" type="text/javascript"></script>

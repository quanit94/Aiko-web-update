  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Hãy bắt đầu phiên làm việc của bạn</p>
        @include('message.message')
        {!! Form::open(array('route'=>array('post.auth.auth.login'))) !!}
          ...
          <div class="form-group has-feedback">
            {!! Form::password('password',array('class'=>'form-control', 'id'=>'pass', 'placeholder'=>'Nhập mật khẩu của bạn')) !!}
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              {!! Form::submit('Đăng nhập',array('name'=>'submit', 'class'=>'btn btn-primary btn-block btn-flat','id' => 'submit')) !!}
            </div><!-- /.col -->
          </div>
        ...
        <a href="{{ route('get.auth.auth.forgetPassword') }}">Tôi muốn tìm lại mật khẩu</a>

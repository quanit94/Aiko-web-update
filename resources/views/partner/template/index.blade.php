...
<html>
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      @include('partner.template.header')
      <!-- Left side column. contains the logo and sidebar -->
      <?php
        $dataFromSever = Cookie::get("dataFromSever");
      ?>
      @include('partner.home.persional', array('perInfo' => $dataFromSever['data']))
      
      @include('partner.template.menu', array('perInfo' => $dataFromSever['data']))
      ...
      @include('partner.template.footer')
      <!-- Control Sidebar -->
      
      @include('partner.template.skin')
